...
pub type R = crate::R<Ch5cfgr1Spec>;
#[doc = "Register `CH5CFGR1` writer"]
pub type W = crate::W<Ch5cfgr1Spec>;
...
impl W {
    #[doc = "Bits 0:1 - SITP"]
    #[inline(always)]
    pub fn sitp(&mut self) -> SitpW<Ch5cfgr1Spec> {
        SitpW::new(self, 0)
    }
    #[doc = "Bits 2:3 - SPICKSEL"]
    #[inline(always)]
    pub fn spicksel(&mut self) -> SpickselW<Ch5cfgr1Spec> {
        SpickselW::new(self, 2)
    }
    #[doc = "Bit 5 - SCDEN"]
    #[inline(always)]
    pub fn scden(&mut self) -> ScdenW<Ch5cfgr1Spec> {
        ScdenW::new(self, 5)
    }
    #[doc = "Bit 6 - CKABEN"]
    #[inline(always)]
    pub fn ckaben(&mut self) -> CkabenW<Ch5cfgr1Spec> {
        CkabenW::new(self, 6)
    }
    #[doc = "Bit 7 - CHEN"]
    #[inline(always)]
    pub fn chen(&mut self) -> ChenW<Ch5cfgr1Spec> {
        ChenW::new(self, 7)
    }
    #[doc = "Bit 8 - CHINSEL"]
    #[inline(always)]
    pub fn chinsel(&mut self) -> ChinselW<Ch5cfgr1Spec> {
        ChinselW::new(self, 8)
    }
    #[doc = "Bits 12:13 - DATMPX"]
    #[inline(always)]
    pub fn datmpx(&mut self) -> DatmpxW<Ch5cfgr1Spec> {
        DatmpxW::new(self, 12)
    }
    #[doc = "Bits 14:15 - DATPACK"]
    #[inline(always)]
    pub fn datpack(&mut self) -> DatpackW<Ch5cfgr1Spec> {
...
pub struct Ch5cfgr1Spec;
impl crate::RegisterSpec for Ch5cfgr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch5cfgr1::R`](R) reader structure"]
impl crate::Readable for Ch5cfgr1Spec {}
#[doc = "`write(|w| ..)` method takes [`ch5cfgr1::W`](W) writer structure"]
impl crate::Writable for Ch5cfgr1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH5CFGR1 to value 0"]
impl crate::Resettable for Ch5cfgr1Spec {}
