...
pub type R = crate::R<DfsdmFlt2fcrSpec>;
#[doc = "Register `DFSDM_FLT2FCR` writer"]
pub type W = crate::W<DfsdmFlt2fcrSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Integrator oversampling ratio (averaging length)"]
    #[inline(always)]
    pub fn iosr(&mut self) -> IosrW<DfsdmFlt2fcrSpec> {
        IosrW::new(self, 0)
    }
    #[doc = "Bits 16:25 - Sinc filter oversampling ratio (decimation rate)"]
    #[inline(always)]
    pub fn fosr(&mut self) -> FosrW<DfsdmFlt2fcrSpec> {
        FosrW::new(self, 16)
    }
    #[doc = "Bits 29:31 - Sinc filter order"]
    #[inline(always)]
    pub fn ford(&mut self) -> FordW<DfsdmFlt2fcrSpec> {
        FordW::new(self, 29)
    }
}
...
pub struct DfsdmFlt2fcrSpec;
impl crate::RegisterSpec for DfsdmFlt2fcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt2fcr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt2fcrSpec {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt2fcr::W`](W) writer structure"]
impl crate::Writable for DfsdmFlt2fcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DFSDM_FLT2FCR to value 0"]
impl crate::Resettable for DfsdmFlt2fcrSpec {}
