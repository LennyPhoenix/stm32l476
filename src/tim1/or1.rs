...
pub type EtrAdc1RmpR = crate::FieldReader;
#[doc = "Field `ETR_ADC1_RMP` writer - External trigger remap on ADC1 analog watchdog"]
pub type EtrAdc1RmpW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
impl R {
    ...
    #[inline(always)]
    pub fn etr_adc1_rmp(&self) -> EtrAdc1RmpR {
        EtrAdc1RmpR::new((self.bits & 3) as u8)
    }
...
impl W {
    #[doc = "Bits 0:1 - External trigger remap on ADC1 analog watchdog"]
    #[inline(always)]
    pub fn etr_adc1_rmp(&mut self) -> EtrAdc1RmpW<Or1Spec> {
        EtrAdc1RmpW::new(self, 0)
    }
    #[doc = "Bits 2:3 - External trigger remap on ADC3 analog watchdog"]
    #[inline(always)]
