...
pub type DfsdmcfgR = crate::BitReader;
#[doc = "Field `DFSDMCFG` writer - DFSDMCFG"]
pub type DfsdmcfgW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[doc = "Bit 2 - DFSDMCFG"]
    #[inline(always)]
    pub fn dfsdmcfg(&mut self) -> DfsdmcfgW<CfgrSpec> {
        DfsdmcfgW::new(self, 2)
    }
    #[doc = "Bits 3:4 - RES"]
    #[inline(always)]
