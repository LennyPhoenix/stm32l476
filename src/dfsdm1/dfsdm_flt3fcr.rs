...
pub type R = crate::R<DfsdmFlt3fcrSpec>;
#[doc = "Register `DFSDM_FLT3FCR` writer"]
pub type W = crate::W<DfsdmFlt3fcrSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Integrator oversampling ratio (averaging length)"]
    #[inline(always)]
    pub fn iosr(&mut self) -> IosrW<DfsdmFlt3fcrSpec> {
        IosrW::new(self, 0)
    }
    #[doc = "Bits 16:25 - Sinc filter oversampling ratio (decimation rate)"]
    #[inline(always)]
    pub fn fosr(&mut self) -> FosrW<DfsdmFlt3fcrSpec> {
        FosrW::new(self, 16)
    }
    #[doc = "Bits 29:31 - Sinc filter order"]
    #[inline(always)]
    pub fn ford(&mut self) -> FordW<DfsdmFlt3fcrSpec> {
        FordW::new(self, 29)
    }
}
...
pub struct DfsdmFlt3fcrSpec;
impl crate::RegisterSpec for DfsdmFlt3fcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt3fcr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt3fcrSpec {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt3fcr::W`](W) writer structure"]
impl crate::Writable for DfsdmFlt3fcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DFSDM_FLT3FCR to value 0"]
impl crate::Resettable for DfsdmFlt3fcrSpec {}
