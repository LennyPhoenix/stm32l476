...
pub type R = crate::R<Ch4datinrSpec>;
#[doc = "Register `CH4DATINR` writer"]
pub type W = crate::W<Ch4datinrSpec>;
...
impl W {
    #[doc = "Bits 0:15 - INDAT0"]
    #[inline(always)]
    pub fn indat0(&mut self) -> Indat0W<Ch4datinrSpec> {
        Indat0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - INDAT1"]
    #[inline(always)]
    pub fn indat1(&mut self) -> Indat1W<Ch4datinrSpec> {
        Indat1W::new(self, 16)
    }
}
...
pub struct Ch4datinrSpec;
impl crate::RegisterSpec for Ch4datinrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch4datinr::R`](R) reader structure"]
impl crate::Readable for Ch4datinrSpec {}
#[doc = "`write(|w| ..)` method takes [`ch4datinr::W`](W) writer structure"]
impl crate::Writable for Ch4datinrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH4DATINR to value 0"]
impl crate::Resettable for Ch4datinrSpec {}
