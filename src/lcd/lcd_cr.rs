...
#[doc = "Voltage source selection The VSEL bit determines the voltage source for the LCD.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Vsel {
    #[doc = "0: Internal source (voltage step-up converter)"]
    B0x0 = 0,
...
#[doc = "Field `VSEL` reader - Voltage source selection The VSEL bit determines the voltage source for the LCD."]
...
impl VselR {
    ...
    #[doc = "Internal source (voltage step-up converter)"]
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == Vsel::B0x0
    }
...
#[doc = "Field `VSEL` writer - Voltage source selection The VSEL bit determines the voltage source for the LCD."]
...
#[doc = "Duty selection These bits determine the duty cycle.Unused COM pins can serve as general purpose input pins if COMIN is set. Values 101, 110 and 111 are forbidden. Others: Reserved\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Duty {
    #[doc = "0: Static duty"]
...
#[doc = "Field `DUTY` reader - Duty selection These bits determine the duty cycle.Unused COM pins can serve as general purpose input pins if COMIN is set. Values 101, 110 and 111 are forbidden. Others: Reserved"]
...
#[doc = "Field `DUTY` writer - Duty selection These bits determine the duty cycle.Unused COM pins can serve as general purpose input pins if COMIN is set. Values 101, 110 and 111 are forbidden. Others: Reserved"]
...
#[doc = "Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\\[31:28\\] or SEG\\[15:12\\]. See Sectionm19.3.7.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MuxSeg {
    #[doc = "0: SEG pin multiplexing disabled"]
    B0x0 = 0,
    #[doc = "1: SEG\\[31:28\\] are multiplexed with SEG\\[43:40\\]"]
    B0x1 = 1,
}
...
#[doc = "Field `MUX_SEG` reader - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\\[31:28\\] or SEG\\[15:12\\]. See Sectionm19.3.7."]
...
impl MuxSegR {
    ...
    #[doc = "SEG\\[31:28\\] are multiplexed with SEG\\[43:40\\]"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == MuxSeg::B0x1
    }
}
#[doc = "Field `MUX_SEG` writer - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\\[31:28\\] or SEG\\[15:12\\]. See Sectionm19.3.7."]
...
impl R {
    ...
    #[doc = "Bit 1 - Voltage source selection The VSEL bit determines the voltage source for the LCD."]
    #[inline(always)]
    pub fn vsel(&self) -> VselR {
        VselR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:4 - Duty selection These bits determine the duty cycle.Unused COM pins can serve as general purpose input pins if COMIN is set. Values 101, 110 and 111 are forbidden. Others: Reserved"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - Mux segment enable This bit is used to enable SEG pin remapping. Four SEG pins can be multiplexed with SEG\\[31:28\\] or SEG\\[15:12\\]. See Sectionm19.3.7."]
    #[inline(always)]
