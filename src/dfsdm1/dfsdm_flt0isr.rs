...
pub type R = crate::R<DfsdmFlt0isrSpec>;
...
pub struct DfsdmFlt0isrSpec;
impl crate::RegisterSpec for DfsdmFlt0isrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt0isr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt0isrSpec {}
#[doc = "`reset()` method sets DFSDM_FLT0ISR to value 0x00ff_0000"]
impl crate::Resettable for DfsdmFlt0isrSpec {
