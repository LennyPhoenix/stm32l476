...
pub type R = crate::R<DfsdmFlt0icrSpec>;
#[doc = "Register `DFSDM_FLT0ICR` writer"]
pub type W = crate::W<DfsdmFlt0icrSpec>;
...
impl W {
    #[doc = "Bit 2 - Clear the injected conversion overrun flag"]
    #[inline(always)]
    pub fn clrjovrf(&mut self) -> ClrjovrfW<DfsdmFlt0icrSpec> {
        ClrjovrfW::new(self, 2)
    }
    #[doc = "Bit 3 - Clear the regular conversion overrun flag"]
    #[inline(always)]
    pub fn clrrovrf(&mut self) -> ClrrovrfW<DfsdmFlt0icrSpec> {
        ClrrovrfW::new(self, 3)
    }
    #[doc = "Bits 16:23 - Clear the clock absence flag"]
    #[inline(always)]
    pub fn clrckabf(&mut self) -> ClrckabfW<DfsdmFlt0icrSpec> {
        ClrckabfW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Clear the short-circuit detector flag"]
    #[inline(always)]
    pub fn clrscdf(&mut self) -> ClrscdfW<DfsdmFlt0icrSpec> {
...
pub struct DfsdmFlt0icrSpec;
impl crate::RegisterSpec for DfsdmFlt0icrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt0icr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt0icrSpec {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt0icr::W`](W) writer structure"]
impl crate::Writable for DfsdmFlt0icrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DFSDM_FLT0ICR to value 0"]
impl crate::Resettable for DfsdmFlt0icrSpec {}
