#[doc = "Register `LCD_RAM14` reader"]
pub type R = crate::R<LcdRam14Spec>;
#[doc = "Register `LCD_RAM14` writer"]
pub type W = crate::W<LcdRam14Spec>;
...
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one pixel of the LCD display."]
    #[inline(always)]
    pub fn segment_data(&mut self) -> SegmentDataW<LcdRam14Spec> {
...
pub struct LcdRam14Spec;
impl crate::RegisterSpec for LcdRam14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_ram14::R`](R) reader structure"]
impl crate::Readable for LcdRam14Spec {}
#[doc = "`write(|w| ..)` method takes [`lcd_ram14::W`](W) writer structure"]
impl crate::Writable for LcdRam14Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RAM14 to value 0"]
impl crate::Resettable for LcdRam14Spec {}
