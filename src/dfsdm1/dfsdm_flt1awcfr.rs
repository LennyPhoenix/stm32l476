...
pub type R = crate::R<DfsdmFlt1awcfrSpec>;
#[doc = "Register `DFSDM_FLT1AWCFR` writer"]
pub type W = crate::W<DfsdmFlt1awcfrSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clear the analog watchdog low threshold flag"]
    #[inline(always)]
    pub fn clrawltf(&mut self) -> ClrawltfW<DfsdmFlt1awcfrSpec> {
        ClrawltfW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Clear the analog watchdog high threshold flag"]
    #[inline(always)]
    pub fn clrawhtf(&mut self) -> ClrawhtfW<DfsdmFlt1awcfrSpec> {
...
pub struct DfsdmFlt1awcfrSpec;
impl crate::RegisterSpec for DfsdmFlt1awcfrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt1awcfr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt1awcfrSpec {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt1awcfr::W`](W) writer structure"]
impl crate::Writable for DfsdmFlt1awcfrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DFSDM_FLT1AWCFR to value 0"]
impl crate::Resettable for DfsdmFlt1awcfrSpec {}
