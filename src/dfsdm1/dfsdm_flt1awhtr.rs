...
pub type R = crate::R<DfsdmFlt1awhtrSpec>;
#[doc = "Register `DFSDM_FLT1AWHTR` writer"]
pub type W = crate::W<DfsdmFlt1awhtrSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Break signal assignment to analog watchdog high threshold event"]
    #[inline(always)]
    pub fn bkawh(&mut self) -> BkawhW<DfsdmFlt1awhtrSpec> {
        BkawhW::new(self, 0)
    }
    #[doc = "Bits 8:31 - Analog watchdog high threshold"]
    #[inline(always)]
    pub fn awht(&mut self) -> AwhtW<DfsdmFlt1awhtrSpec> {
        AwhtW::new(self, 8)
    }
}
...
pub struct DfsdmFlt1awhtrSpec;
impl crate::RegisterSpec for DfsdmFlt1awhtrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt1awhtr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt1awhtrSpec {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt1awhtr::W`](W) writer structure"]
impl crate::Writable for DfsdmFlt1awhtrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DFSDM_FLT1AWHTR to value 0"]
impl crate::Resettable for DfsdmFlt1awhtrSpec {}
