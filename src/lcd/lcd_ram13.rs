#[doc = "Register `LCD_RAM13` reader"]
pub type R = crate::R<LcdRam13Spec>;
#[doc = "Register `LCD_RAM13` writer"]
pub type W = crate::W<LcdRam13Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Each bit corresponds to one pixel of the LCD display."]
    #[inline(always)]
    pub fn segment_data(&mut self) -> SegmentDataW<LcdRam13Spec> {
...
pub struct LcdRam13Spec;
impl crate::RegisterSpec for LcdRam13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_ram13::R`](R) reader structure"]
impl crate::Readable for LcdRam13Spec {}
#[doc = "`write(|w| ..)` method takes [`lcd_ram13::W`](W) writer structure"]
impl crate::Writable for LcdRam13Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RAM13 to value 0"]
impl crate::Resettable for LcdRam13Spec {}
