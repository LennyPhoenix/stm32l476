...
pub type R = crate::R<Ch1datinrSpec>;
#[doc = "Register `CH1DATINR` writer"]
pub type W = crate::W<Ch1datinrSpec>;
...
impl W {
    #[doc = "Bits 0:15 - INDAT0"]
    #[inline(always)]
    pub fn indat0(&mut self) -> Indat0W<Ch1datinrSpec> {
        Indat0W::new(self, 0)
    }
    #[doc = "Bits 16:31 - INDAT1"]
    #[inline(always)]
    pub fn indat1(&mut self) -> Indat1W<Ch1datinrSpec> {
        Indat1W::new(self, 16)
    }
}
...
pub struct Ch1datinrSpec;
impl crate::RegisterSpec for Ch1datinrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1datinr::R`](R) reader structure"]
impl crate::Readable for Ch1datinrSpec {}
#[doc = "`write(|w| ..)` method takes [`ch1datinr::W`](W) writer structure"]
impl crate::Writable for Ch1datinrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH1DATINR to value 0"]
impl crate::Resettable for Ch1datinrSpec {}
