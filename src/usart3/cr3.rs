...
pub type UcesmR = crate::BitReader;
#[doc = "Field `UCESM` writer - USART Clock Enable in Stop mode."]
pub type UcesmW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TCBGTIE_` reader - Transmission complete before guard time interrupt enable"]
pub type Tcbgtie_R = crate::BitReader;
#[doc = "Field `TCBGTIE_` writer - Transmission complete before guard time interrupt enable"]
...
impl W {
    ...
    #[doc = "Bit 23 - USART Clock Enable in Stop mode."]
    #[inline(always)]
    pub fn ucesm(&mut self) -> UcesmW<Cr3Spec> {
        UcesmW::new(self, 23)
    }
    #[doc = "Bit 24 - Transmission complete before guard time interrupt enable"]
    #[inline(always)]
    pub fn tcbgtie_(&mut self) -> Tcbgtie_W<Cr3Spec> {
