...
pub type R = crate::R<DfsdmFlt3rdatarSpec>;
...
pub struct DfsdmFlt3rdatarSpec;
impl crate::RegisterSpec for DfsdmFlt3rdatarSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt3rdatar::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt3rdatarSpec {}
#[doc = "`reset()` method sets DFSDM_FLT3RDATAR to value 0"]
impl crate::Resettable for DfsdmFlt3rdatarSpec {}
