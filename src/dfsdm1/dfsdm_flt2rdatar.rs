...
pub type R = crate::R<DfsdmFlt2rdatarSpec>;
...
pub struct DfsdmFlt2rdatarSpec;
impl crate::RegisterSpec for DfsdmFlt2rdatarSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt2rdatar::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt2rdatarSpec {}
#[doc = "`reset()` method sets DFSDM_FLT2RDATAR to value 0"]
impl crate::Resettable for DfsdmFlt2rdatarSpec {}
