...
pub type R = crate::R<Ch0awscdrSpec>;
#[doc = "Register `CH0AWSCDR` writer"]
pub type W = crate::W<Ch0awscdrSpec>;
...
impl W {
    #[doc = "Bits 0:7 - SCDT"]
    #[inline(always)]
    pub fn scdt(&mut self) -> ScdtW<Ch0awscdrSpec> {
        ScdtW::new(self, 0)
    }
    #[doc = "Bits 12:15 - BKSCD"]
    #[inline(always)]
    pub fn bkscd(&mut self) -> BkscdW<Ch0awscdrSpec> {
        BkscdW::new(self, 12)
    }
    #[doc = "Bits 16:20 - AWFOSR"]
    #[inline(always)]
    pub fn awfosr(&mut self) -> AwfosrW<Ch0awscdrSpec> {
        AwfosrW::new(self, 16)
    }
    #[doc = "Bits 22:23 - AWFORD"]
    #[inline(always)]
    pub fn awford(&mut self) -> AwfordW<Ch0awscdrSpec> {
        AwfordW::new(self, 22)
    }
}
...
pub struct Ch0awscdrSpec;
impl crate::RegisterSpec for Ch0awscdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch0awscdr::R`](R) reader structure"]
impl crate::Readable for Ch0awscdrSpec {}
#[doc = "`write(|w| ..)` method takes [`ch0awscdr::W`](W) writer structure"]
impl crate::Writable for Ch0awscdrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH0AWSCDR to value 0"]
impl crate::Resettable for Ch0awscdrSpec {}
