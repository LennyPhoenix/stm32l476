#[doc = "Register `LCD_RAM4` reader"]
pub type R = crate::R<LcdRam4Spec>;
#[doc = "Register `LCD_RAM4` writer"]
pub type W = crate::W<LcdRam4Spec>;
...
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one pixel of the LCD display."]
    #[inline(always)]
    pub fn segment_data(&mut self) -> SegmentDataW<LcdRam4Spec> {
...
pub struct LcdRam4Spec;
impl crate::RegisterSpec for LcdRam4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_ram4::R`](R) reader structure"]
impl crate::Readable for LcdRam4Spec {}
#[doc = "`write(|w| ..)` method takes [`lcd_ram4::W`](W) writer structure"]
impl crate::Writable for LcdRam4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RAM4 to value 0"]
impl crate::Resettable for LcdRam4Spec {}
