...
pub type R = crate::R<PdcrgSpec>;
#[doc = "Register `PDCRG` writer"]
pub type W = crate::W<PdcrgSpec>;
...
impl W {
    #[doc = "Bit 0 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd0(&mut self) -> Pd0W<PdcrgSpec> {
        Pd0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd1(&mut self) -> Pd1W<PdcrgSpec> {
        Pd1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd2(&mut self) -> Pd2W<PdcrgSpec> {
        Pd2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd3(&mut self) -> Pd3W<PdcrgSpec> {
        Pd3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd4(&mut self) -> Pd4W<PdcrgSpec> {
        Pd4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd5(&mut self) -> Pd5W<PdcrgSpec> {
        Pd5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd6(&mut self) -> Pd6W<PdcrgSpec> {
        Pd6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd7(&mut self) -> Pd7W<PdcrgSpec> {
        Pd7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd8(&mut self) -> Pd8W<PdcrgSpec> {
        Pd8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd9(&mut self) -> Pd9W<PdcrgSpec> {
        Pd9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd10(&mut self) -> Pd10W<PdcrgSpec> {
        Pd10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd11(&mut self) -> Pd11W<PdcrgSpec> {
        Pd11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd12(&mut self) -> Pd12W<PdcrgSpec> {
        Pd12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd13(&mut self) -> Pd13W<PdcrgSpec> {
        Pd13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd14(&mut self) -> Pd14W<PdcrgSpec> {
        Pd14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port G pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn pd15(&mut self) -> Pd15W<PdcrgSpec> {
        Pd15W::new(self, 15)
    }
}
...
pub struct PdcrgSpec;
impl crate::RegisterSpec for PdcrgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pdcrg::R`](R) reader structure"]
impl crate::Readable for PdcrgSpec {}
#[doc = "`write(|w| ..)` method takes [`pdcrg::W`](W) writer structure"]
impl crate::Writable for PdcrgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PDCRG to value 0"]
impl crate::Resettable for PdcrgSpec {}
