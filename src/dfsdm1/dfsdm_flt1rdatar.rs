...
pub type R = crate::R<DfsdmFlt1rdatarSpec>;
...
pub struct DfsdmFlt1rdatarSpec;
impl crate::RegisterSpec for DfsdmFlt1rdatarSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt1rdatar::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt1rdatarSpec {}
#[doc = "`reset()` method sets DFSDM_FLT1RDATAR to value 0"]
impl crate::Resettable for DfsdmFlt1rdatarSpec {}
