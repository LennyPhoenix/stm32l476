...
pub type R = crate::R<Ch2cfgr2Spec>;
#[doc = "Register `CH2CFGR2` writer"]
pub type W = crate::W<Ch2cfgr2Spec>;
...
impl W {
    #[doc = "Bits 3:7 - DTRBS"]
    #[inline(always)]
    pub fn dtrbs(&mut self) -> DtrbsW<Ch2cfgr2Spec> {
        DtrbsW::new(self, 3)
    }
    #[doc = "Bits 8:31 - OFFSET"]
    #[inline(always)]
    pub fn offset(&mut self) -> OffsetW<Ch2cfgr2Spec> {
        OffsetW::new(self, 8)
    }
}
...
pub struct Ch2cfgr2Spec;
impl crate::RegisterSpec for Ch2cfgr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch2cfgr2::R`](R) reader structure"]
impl crate::Readable for Ch2cfgr2Spec {}
#[doc = "`write(|w| ..)` method takes [`ch2cfgr2::W`](W) writer structure"]
impl crate::Writable for Ch2cfgr2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH2CFGR2 to value 0"]
impl crate::Resettable for Ch2cfgr2Spec {}
