...
pub type Bkdfbk2eR = crate::BitReader;
#[doc = "Field `BKDFBK2E` writer - BRK DFSDM_BREAK2 enable"]
pub type Bkdfbk2eW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[doc = "Bit 8 - BRK DFSDM_BREAK2 enable"]
    #[inline(always)]
    pub fn bkdfbk2e(&mut self) -> Bkdfbk2eW<Or2Spec> {
        Bkdfbk2eW::new(self, 8)
    }
    #[doc = "Bit 9 - BRK BKIN input polarity"]
    #[inline(always)]
