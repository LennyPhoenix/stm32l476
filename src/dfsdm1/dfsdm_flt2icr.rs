...
pub type R = crate::R<DfsdmFlt2icrSpec>;
#[doc = "Register `DFSDM_FLT2ICR` writer"]
pub type W = crate::W<DfsdmFlt2icrSpec>;
...
impl W {
    #[doc = "Bit 2 - Clear the injected conversion overrun flag"]
    #[inline(always)]
    pub fn clrjovrf(&mut self) -> ClrjovrfW<DfsdmFlt2icrSpec> {
        ClrjovrfW::new(self, 2)
    }
    #[doc = "Bit 3 - Clear the regular conversion overrun flag"]
    #[inline(always)]
    pub fn clrrovrf(&mut self) -> ClrrovrfW<DfsdmFlt2icrSpec> {
        ClrrovrfW::new(self, 3)
    }
    #[doc = "Bits 16:23 - Clear the clock absence flag"]
    #[inline(always)]
    pub fn clrckabf(&mut self) -> ClrckabfW<DfsdmFlt2icrSpec> {
        ClrckabfW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Clear the short-circuit detector flag"]
    #[inline(always)]
    pub fn clrscdf(&mut self) -> ClrscdfW<DfsdmFlt2icrSpec> {
...
pub struct DfsdmFlt2icrSpec;
impl crate::RegisterSpec for DfsdmFlt2icrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt2icr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt2icrSpec {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt2icr::W`](W) writer structure"]
impl crate::Writable for DfsdmFlt2icrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DFSDM_FLT2ICR to value 0"]
impl crate::Resettable for DfsdmFlt2icrSpec {}
