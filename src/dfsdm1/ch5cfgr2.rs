...
pub type R = crate::R<Ch5cfgr2Spec>;
#[doc = "Register `CH5CFGR2` writer"]
pub type W = crate::W<Ch5cfgr2Spec>;
...
impl W {
    #[doc = "Bits 3:7 - DTRBS"]
    #[inline(always)]
    pub fn dtrbs(&mut self) -> DtrbsW<Ch5cfgr2Spec> {
        DtrbsW::new(self, 3)
    }
    #[doc = "Bits 8:31 - OFFSET"]
    #[inline(always)]
    pub fn offset(&mut self) -> OffsetW<Ch5cfgr2Spec> {
        OffsetW::new(self, 8)
    }
}
...
pub struct Ch5cfgr2Spec;
impl crate::RegisterSpec for Ch5cfgr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch5cfgr2::R`](R) reader structure"]
impl crate::Readable for Ch5cfgr2Spec {}
#[doc = "`write(|w| ..)` method takes [`ch5cfgr2::W`](W) writer structure"]
impl crate::Writable for Ch5cfgr2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH5CFGR2 to value 0"]
impl crate::Resettable for Ch5cfgr2Spec {}
