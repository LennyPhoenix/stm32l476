...
pub type R = crate::R<Ch5wdatrSpec>;
#[doc = "Register `CH5WDATR` writer"]
pub type W = crate::W<Ch5wdatrSpec>;
...
impl W {
    #[doc = "Bits 0:15 - WDATA"]
    #[inline(always)]
    pub fn wdata(&mut self) -> WdataW<Ch5wdatrSpec> {
        WdataW::new(self, 0)
    }
}
...
pub struct Ch5wdatrSpec;
impl crate::RegisterSpec for Ch5wdatrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch5wdatr::R`](R) reader structure"]
impl crate::Readable for Ch5wdatrSpec {}
#[doc = "`write(|w| ..)` method takes [`ch5wdatr::W`](W) writer structure"]
impl crate::Writable for Ch5wdatrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH5WDATR to value 0"]
impl crate::Resettable for Ch5wdatrSpec {}
