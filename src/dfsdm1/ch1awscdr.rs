...
pub type R = crate::R<Ch1awscdrSpec>;
#[doc = "Register `CH1AWSCDR` writer"]
pub type W = crate::W<Ch1awscdrSpec>;
...
impl W {
    #[doc = "Bits 0:7 - SCDT"]
    #[inline(always)]
    pub fn scdt(&mut self) -> ScdtW<Ch1awscdrSpec> {
        ScdtW::new(self, 0)
    }
    #[doc = "Bits 12:15 - BKSCD"]
    #[inline(always)]
    pub fn bkscd(&mut self) -> BkscdW<Ch1awscdrSpec> {
        BkscdW::new(self, 12)
    }
    #[doc = "Bits 16:20 - AWFOSR"]
    #[inline(always)]
    pub fn awfosr(&mut self) -> AwfosrW<Ch1awscdrSpec> {
        AwfosrW::new(self, 16)
    }
    #[doc = "Bits 22:23 - AWFORD"]
    #[inline(always)]
    pub fn awford(&mut self) -> AwfordW<Ch1awscdrSpec> {
        AwfordW::new(self, 22)
    }
}
...
pub struct Ch1awscdrSpec;
impl crate::RegisterSpec for Ch1awscdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1awscdr::R`](R) reader structure"]
impl crate::Readable for Ch1awscdrSpec {}
#[doc = "`write(|w| ..)` method takes [`ch1awscdr::W`](W) writer structure"]
impl crate::Writable for Ch1awscdrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH1AWSCDR to value 0"]
impl crate::Resettable for Ch1awscdrSpec {}
