#[doc = "Register `LCD_RAM0` reader"]
pub type R = crate::R<LcdRam0Spec>;
#[doc = "Register `LCD_RAM0` writer"]
pub type W = crate::W<LcdRam0Spec>;
...
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one pixel of the LCD display."]
    #[inline(always)]
    pub fn segment_data(&mut self) -> SegmentDataW<LcdRam0Spec> {
...
pub struct LcdRam0Spec;
impl crate::RegisterSpec for LcdRam0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_ram0::R`](R) reader structure"]
impl crate::Readable for LcdRam0Spec {}
#[doc = "`write(|w| ..)` method takes [`lcd_ram0::W`](W) writer structure"]
impl crate::Writable for LcdRam0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RAM0 to value 0"]
impl crate::Resettable for LcdRam0Spec {}
