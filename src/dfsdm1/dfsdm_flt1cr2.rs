...
pub type R = crate::R<DfsdmFlt1cr2Spec>;
#[doc = "Register `DFSDM_FLT1CR2` writer"]
pub type W = crate::W<DfsdmFlt1cr2Spec>;
...
impl W {
    #[doc = "Bit 0 - Injected end of conversion interrupt enable"]
    #[inline(always)]
    pub fn jeocie(&mut self) -> JeocieW<DfsdmFlt1cr2Spec> {
        JeocieW::new(self, 0)
    }
    #[doc = "Bit 1 - Regular end of conversion interrupt enable"]
    #[inline(always)]
    pub fn reocie(&mut self) -> ReocieW<DfsdmFlt1cr2Spec> {
        ReocieW::new(self, 1)
    }
    #[doc = "Bit 2 - Injected data overrun interrupt enable"]
    #[inline(always)]
    pub fn jovrie(&mut self) -> JovrieW<DfsdmFlt1cr2Spec> {
        JovrieW::new(self, 2)
    }
    #[doc = "Bit 3 - Regular data overrun interrupt enable"]
    #[inline(always)]
    pub fn rovrie(&mut self) -> RovrieW<DfsdmFlt1cr2Spec> {
        RovrieW::new(self, 3)
    }
    #[doc = "Bit 4 - Analog watchdog interrupt enable"]
    #[inline(always)]
    pub fn awdie(&mut self) -> AwdieW<DfsdmFlt1cr2Spec> {
        AwdieW::new(self, 4)
    }
    #[doc = "Bit 5 - Short-circuit detector interrupt enable"]
    #[inline(always)]
    pub fn scdie(&mut self) -> ScdieW<DfsdmFlt1cr2Spec> {
        ScdieW::new(self, 5)
    }
    #[doc = "Bit 6 - Clock absence interrupt enable"]
    #[inline(always)]
    pub fn ckabie(&mut self) -> CkabieW<DfsdmFlt1cr2Spec> {
        CkabieW::new(self, 6)
    }
    #[doc = "Bits 8:15 - Extremes detector channel selection"]
    #[inline(always)]
    pub fn exch(&mut self) -> ExchW<DfsdmFlt1cr2Spec> {
        ExchW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Analog watchdog channel selection"]
    #[inline(always)]
    pub fn awdch(&mut self) -> AwdchW<DfsdmFlt1cr2Spec> {
        AwdchW::new(self, 16)
    }
}
...
pub struct DfsdmFlt1cr2Spec;
impl crate::RegisterSpec for DfsdmFlt1cr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt1cr2::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt1cr2Spec {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt1cr2::W`](W) writer structure"]
impl crate::Writable for DfsdmFlt1cr2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DFSDM_FLT1CR2 to value 0"]
impl crate::Resettable for DfsdmFlt1cr2Spec {}
