...
pub type Bk2dfbk3eR = crate::BitReader;
#[doc = "Field `BK2DFBK3E` writer - BRK2 DFSDM_BREAK3 enable"]
pub type Bk2dfbk3eW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    pub fn bk2dfbk3e(&self) -> Bk2dfbk3eR {
        Bk2dfbk3eR::new(((self.bits >> 8) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 8 - BRK2 DFSDM_BREAK3 enable"]
    #[inline(always)]
    pub fn bk2dfbk3e(&mut self) -> Bk2dfbk3eW<Or3Spec> {
        Bk2dfbk3eW::new(self, 8)
    }
    #[doc = "Bit 9 - BRK2 BKIN input polarity"]
    #[inline(always)]
