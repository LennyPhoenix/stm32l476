...
pub type R = crate::R<DfsdmFlt1isrSpec>;
...
pub struct DfsdmFlt1isrSpec;
impl crate::RegisterSpec for DfsdmFlt1isrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt1isr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt1isrSpec {}
#[doc = "`reset()` method sets DFSDM_FLT1ISR to value 0x00ff_0000"]
impl crate::Resettable for DfsdmFlt1isrSpec {
