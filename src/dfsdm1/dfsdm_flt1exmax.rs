...
pub type R = crate::R<DfsdmFlt1exmaxSpec>;
...
pub struct DfsdmFlt1exmaxSpec;
impl crate::RegisterSpec for DfsdmFlt1exmaxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt1exmax::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt1exmaxSpec {}
#[doc = "`reset()` method sets DFSDM_FLT1EXMAX to value 0x8000_0000"]
impl crate::Resettable for DfsdmFlt1exmaxSpec {
