...
pub type R = crate::R<Ch2awscdrSpec>;
#[doc = "Register `CH2AWSCDR` writer"]
pub type W = crate::W<Ch2awscdrSpec>;
...
impl W {
    #[doc = "Bits 0:7 - SCDT"]
    #[inline(always)]
    pub fn scdt(&mut self) -> ScdtW<Ch2awscdrSpec> {
        ScdtW::new(self, 0)
    }
    #[doc = "Bits 12:15 - BKSCD"]
    #[inline(always)]
    pub fn bkscd(&mut self) -> BkscdW<Ch2awscdrSpec> {
        BkscdW::new(self, 12)
    }
    #[doc = "Bits 16:20 - AWFOSR"]
    #[inline(always)]
    pub fn awfosr(&mut self) -> AwfosrW<Ch2awscdrSpec> {
        AwfosrW::new(self, 16)
    }
    #[doc = "Bits 22:23 - AWFORD"]
    #[inline(always)]
    pub fn awford(&mut self) -> AwfordW<Ch2awscdrSpec> {
        AwfordW::new(self, 22)
    }
}
...
pub struct Ch2awscdrSpec;
impl crate::RegisterSpec for Ch2awscdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch2awscdr::R`](R) reader structure"]
impl crate::Readable for Ch2awscdrSpec {}
#[doc = "`write(|w| ..)` method takes [`ch2awscdr::W`](W) writer structure"]
impl crate::Writable for Ch2awscdrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH2AWSCDR to value 0"]
impl crate::Resettable for Ch2awscdrSpec {}
