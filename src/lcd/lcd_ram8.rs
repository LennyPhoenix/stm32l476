#[doc = "Register `LCD_RAM8` reader"]
pub type R = crate::R<LcdRam8Spec>;
#[doc = "Register `LCD_RAM8` writer"]
pub type W = crate::W<LcdRam8Spec>;
...
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one pixel of the LCD display."]
    #[inline(always)]
    pub fn segment_data(&mut self) -> SegmentDataW<LcdRam8Spec> {
...
pub struct LcdRam8Spec;
impl crate::RegisterSpec for LcdRam8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_ram8::R`](R) reader structure"]
impl crate::Readable for LcdRam8Spec {}
#[doc = "`write(|w| ..)` method takes [`lcd_ram8::W`](W) writer structure"]
impl crate::Writable for LcdRam8Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RAM8 to value 0"]
impl crate::Resettable for LcdRam8Spec {}
