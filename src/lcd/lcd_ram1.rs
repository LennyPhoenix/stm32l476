#[doc = "Register `LCD_RAM1` reader"]
pub type R = crate::R<LcdRam1Spec>;
#[doc = "Register `LCD_RAM1` writer"]
pub type W = crate::W<LcdRam1Spec>;
...
impl W {
    #[doc = "Bits 0:11 - Each bit corresponds to one pixel of the LCD display."]
    #[inline(always)]
    pub fn segment_data(&mut self) -> SegmentDataW<LcdRam1Spec> {
        SegmentDataW::new(self, 0)
    }
}
#[doc = "LCD display memory\n\nYou can [`read`](crate::Reg::read) this register and get [`lcd_ram1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lcd_ram1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LcdRam1Spec;
impl crate::RegisterSpec for LcdRam1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_ram1::R`](R) reader structure"]
impl crate::Readable for LcdRam1Spec {}
#[doc = "`write(|w| ..)` method takes [`lcd_ram1::W`](W) writer structure"]
impl crate::Writable for LcdRam1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RAM1 to value 0"]
impl crate::Resettable for LcdRam1Spec {}
