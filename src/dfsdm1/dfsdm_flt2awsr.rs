...
pub type R = crate::R<DfsdmFlt2awsrSpec>;
...
pub struct DfsdmFlt2awsrSpec;
impl crate::RegisterSpec for DfsdmFlt2awsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt2awsr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt2awsrSpec {}
#[doc = "`reset()` method sets DFSDM_FLT2AWSR to value 0"]
impl crate::Resettable for DfsdmFlt2awsrSpec {}
