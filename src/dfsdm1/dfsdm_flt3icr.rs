...
pub type R = crate::R<DfsdmFlt3icrSpec>;
#[doc = "Register `DFSDM_FLT3ICR` writer"]
pub type W = crate::W<DfsdmFlt3icrSpec>;
...
impl W {
    #[doc = "Bit 2 - Clear the injected conversion overrun flag"]
    #[inline(always)]
    pub fn clrjovrf(&mut self) -> ClrjovrfW<DfsdmFlt3icrSpec> {
        ClrjovrfW::new(self, 2)
    }
    #[doc = "Bit 3 - Clear the regular conversion overrun flag"]
    #[inline(always)]
    pub fn clrrovrf(&mut self) -> ClrrovrfW<DfsdmFlt3icrSpec> {
        ClrrovrfW::new(self, 3)
    }
    #[doc = "Bits 16:23 - Clear the clock absence flag"]
    #[inline(always)]
    pub fn clrckabf(&mut self) -> ClrckabfW<DfsdmFlt3icrSpec> {
        ClrckabfW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Clear the short-circuit detector flag"]
    #[inline(always)]
    pub fn clrscdf(&mut self) -> ClrscdfW<DfsdmFlt3icrSpec> {
...
pub struct DfsdmFlt3icrSpec;
impl crate::RegisterSpec for DfsdmFlt3icrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt3icr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt3icrSpec {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt3icr::W`](W) writer structure"]
impl crate::Writable for DfsdmFlt3icrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DFSDM_FLT3ICR to value 0"]
impl crate::Resettable for DfsdmFlt3icrSpec {}
