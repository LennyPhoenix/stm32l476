#[doc = "Register `LCD_RAM10` reader"]
pub type R = crate::R<LcdRam10Spec>;
#[doc = "Register `LCD_RAM10` writer"]
pub type W = crate::W<LcdRam10Spec>;
...
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one pixel of the LCD display."]
    #[inline(always)]
    pub fn segment_data(&mut self) -> SegmentDataW<LcdRam10Spec> {
...
pub struct LcdRam10Spec;
impl crate::RegisterSpec for LcdRam10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_ram10::R`](R) reader structure"]
impl crate::Readable for LcdRam10Spec {}
#[doc = "`write(|w| ..)` method takes [`lcd_ram10::W`](W) writer structure"]
impl crate::Writable for LcdRam10Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RAM10 to value 0"]
impl crate::Resettable for LcdRam10Spec {}
