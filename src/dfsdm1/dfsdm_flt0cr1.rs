...
pub type R = crate::R<DfsdmFlt0cr1Spec>;
#[doc = "Register `DFSDM_FLT0CR1` writer"]
pub type W = crate::W<DfsdmFlt0cr1Spec>;
...
impl W {
    #[doc = "Bit 0 - DFSDM enable"]
    #[inline(always)]
    pub fn dfen(&mut self) -> DfenW<DfsdmFlt0cr1Spec> {
        DfenW::new(self, 0)
    }
    #[doc = "Bit 1 - Start a conversion of the injected group of channels"]
    #[inline(always)]
    pub fn jswstart(&mut self) -> JswstartW<DfsdmFlt0cr1Spec> {
        JswstartW::new(self, 1)
    }
    #[doc = "Bit 3 - Launch an injected conversion synchronously with the DFSDM0 JSWSTART trigger"]
    #[inline(always)]
    pub fn jsync(&mut self) -> JsyncW<DfsdmFlt0cr1Spec> {
        JsyncW::new(self, 3)
    }
    #[doc = "Bit 4 - Scanning conversion mode for injected conversions"]
    #[inline(always)]
    pub fn jscan(&mut self) -> JscanW<DfsdmFlt0cr1Spec> {
        JscanW::new(self, 4)
    }
    #[doc = "Bit 5 - DMA channel enabled to read data for the injected channel group"]
    #[inline(always)]
    pub fn jdmaen(&mut self) -> JdmaenW<DfsdmFlt0cr1Spec> {
        JdmaenW::new(self, 5)
    }
    #[doc = "Bits 8:10 - Trigger signal selection for launching injected conversions"]
    #[inline(always)]
    pub fn jextsel(&mut self) -> JextselW<DfsdmFlt0cr1Spec> {
        JextselW::new(self, 8)
    }
    #[doc = "Bits 13:14 - Trigger enable and trigger edge selection for injected conversions"]
    #[inline(always)]
    pub fn jexten(&mut self) -> JextenW<DfsdmFlt0cr1Spec> {
        JextenW::new(self, 13)
    }
    #[doc = "Bit 17 - Software start of a conversion on the regular channel"]
    #[inline(always)]
    pub fn rswstart(&mut self) -> RswstartW<DfsdmFlt0cr1Spec> {
        RswstartW::new(self, 17)
    }
    #[doc = "Bit 18 - Continuous mode selection for regular conversions"]
    #[inline(always)]
    pub fn rcont(&mut self) -> RcontW<DfsdmFlt0cr1Spec> {
        RcontW::new(self, 18)
    }
    #[doc = "Bit 19 - Launch regular conversion synchronously with DFSDM0"]
    #[inline(always)]
    pub fn rsync(&mut self) -> RsyncW<DfsdmFlt0cr1Spec> {
        RsyncW::new(self, 19)
    }
    #[doc = "Bit 21 - DMA channel enabled to read data for the regular conversion"]
    #[inline(always)]
    pub fn rdmaen(&mut self) -> RdmaenW<DfsdmFlt0cr1Spec> {
        RdmaenW::new(self, 21)
    }
    #[doc = "Bits 24:26 - Regular channel selection"]
    #[inline(always)]
    pub fn rch(&mut self) -> RchW<DfsdmFlt0cr1Spec> {
        RchW::new(self, 24)
    }
    #[doc = "Bit 29 - Fast conversion mode selection for regular conversions"]
    #[inline(always)]
    pub fn fast(&mut self) -> FastW<DfsdmFlt0cr1Spec> {
        FastW::new(self, 29)
    }
    #[doc = "Bit 30 - Analog watchdog fast mode select"]
    #[inline(always)]
    pub fn awfsel(&mut self) -> AwfselW<DfsdmFlt0cr1Spec> {
        AwfselW::new(self, 30)
    }
}
...
pub struct DfsdmFlt0cr1Spec;
impl crate::RegisterSpec for DfsdmFlt0cr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt0cr1::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt0cr1Spec {}
#[doc = "`write(|w| ..)` method takes [`dfsdm_flt0cr1::W`](W) writer structure"]
impl crate::Writable for DfsdmFlt0cr1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DFSDM_FLT0CR1 to value 0"]
impl crate::Resettable for DfsdmFlt0cr1Spec {}
