...
pub type R = crate::R<DfsdmFlt3isrSpec>;
...
pub struct DfsdmFlt3isrSpec;
impl crate::RegisterSpec for DfsdmFlt3isrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dfsdm_flt3isr::R`](R) reader structure"]
impl crate::Readable for DfsdmFlt3isrSpec {}
#[doc = "`reset()` method sets DFSDM_FLT3ISR to value 0x00ff_0000"]
impl crate::Resettable for DfsdmFlt3isrSpec {
