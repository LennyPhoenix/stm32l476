...
pub type R = crate::R<PucrgSpec>;
#[doc = "Register `PUCRG` writer"]
pub type W = crate::W<PucrgSpec>;
...
impl W {
    #[doc = "Bit 0 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu0(&mut self) -> Pu0W<PucrgSpec> {
        Pu0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu1(&mut self) -> Pu1W<PucrgSpec> {
        Pu1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu2(&mut self) -> Pu2W<PucrgSpec> {
        Pu2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu3(&mut self) -> Pu3W<PucrgSpec> {
        Pu3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu4(&mut self) -> Pu4W<PucrgSpec> {
        Pu4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu5(&mut self) -> Pu5W<PucrgSpec> {
        Pu5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu6(&mut self) -> Pu6W<PucrgSpec> {
        Pu6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu7(&mut self) -> Pu7W<PucrgSpec> {
        Pu7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu8(&mut self) -> Pu8W<PucrgSpec> {
        Pu8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu9(&mut self) -> Pu9W<PucrgSpec> {
        Pu9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu10(&mut self) -> Pu10W<PucrgSpec> {
        Pu10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu11(&mut self) -> Pu11W<PucrgSpec> {
        Pu11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu12(&mut self) -> Pu12W<PucrgSpec> {
        Pu12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu13(&mut self) -> Pu13W<PucrgSpec> {
        Pu13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu14(&mut self) -> Pu14W<PucrgSpec> {
        Pu14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port G pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu15(&mut self) -> Pu15W<PucrgSpec> {
        Pu15W::new(self, 15)
    }
}
...
pub struct PucrgSpec;
impl crate::RegisterSpec for PucrgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pucrg::R`](R) reader structure"]
impl crate::Readable for PucrgSpec {}
#[doc = "`write(|w| ..)` method takes [`pucrg::W`](W) writer structure"]
impl crate::Writable for PucrgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PUCRG to value 0"]
impl crate::Resettable for PucrgSpec {}
