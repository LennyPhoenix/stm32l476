...
pub type R = crate::R<Ch7wdatrSpec>;
#[doc = "Register `CH7WDATR` writer"]
pub type W = crate::W<Ch7wdatrSpec>;
...
impl W {
    #[doc = "Bits 0:15 - WDATA"]
    #[inline(always)]
    pub fn wdata(&mut self) -> WdataW<Ch7wdatrSpec> {
        WdataW::new(self, 0)
    }
}
...
pub struct Ch7wdatrSpec;
impl crate::RegisterSpec for Ch7wdatrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch7wdatr::R`](R) reader structure"]
impl crate::Readable for Ch7wdatrSpec {}
#[doc = "`write(|w| ..)` method takes [`ch7wdatr::W`](W) writer structure"]
impl crate::Writable for Ch7wdatrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH7WDATR to value 0"]
impl crate::Resettable for Ch7wdatrSpec {}
