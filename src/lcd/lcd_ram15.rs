#[doc = "Register `LCD_RAM15` reader"]
pub type R = crate::R<LcdRam15Spec>;
#[doc = "Register `LCD_RAM15` writer"]
pub type W = crate::W<LcdRam15Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Each bit corresponds to one pixel of the LCD display."]
    #[inline(always)]
    pub fn segment_data(&mut self) -> SegmentDataW<LcdRam15Spec> {
...
pub struct LcdRam15Spec;
impl crate::RegisterSpec for LcdRam15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lcd_ram15::R`](R) reader structure"]
impl crate::Readable for LcdRam15Spec {}
#[doc = "`write(|w| ..)` method takes [`lcd_ram15::W`](W) writer structure"]
impl crate::Writable for LcdRam15Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LCD_RAM15 to value 0"]
impl crate::Resettable for LcdRam15Spec {}
