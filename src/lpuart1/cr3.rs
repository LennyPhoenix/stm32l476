...
#[doc = "Field `UCESM_` reader - LPUART Clock Enable in Stop mode"]
pub type Ucesm_R = crate::BitReader;
#[doc = "Field `UCESM_` writer - LPUART Clock Enable in Stop mode"]
...
impl R {
    ...
    #[doc = "Bit 23 - LPUART Clock Enable in Stop mode"]
    #[inline(always)]
    pub fn ucesm_(&self) -> Ucesm_R {
...
impl W {
    ...
    #[doc = "Bit 23 - LPUART Clock Enable in Stop mode"]
    #[inline(always)]
    pub fn ucesm_(&mut self) -> Ucesm_W<Cr3Spec> {
        Ucesm_W::new(self, 23)
    }
}
